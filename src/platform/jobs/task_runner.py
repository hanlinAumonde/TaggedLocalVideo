...
class TaskRunner:
    ...
    * ``_observer_channels[task_id]`` — ONE queue PER WATCHING CLIENT, carrying progress
    ...
    def __init__(self, max_concurrent: int = 2):
        ...
        self._executors: dict[str, TaskStateMachine] = {}
        ...
        self._latest_progress: dict[str, ProgressFrame] = {}
    ...
    def register_executor(self, key: str, executor: TaskStateMachine) -> None:
        """
        ...
        background job means writing another ``TaskStateMachine`` and registering it here.
        ...
        :type executor: TaskStateMachine
        :rtype: None
        """
    ...
    async def observe(
        self, task_id: str, executor_key: str
    ...
    async def _run_and_broadcast(
        self, executor: TaskStateMachine, task_id: str, start_from: TaskStatus
    ) -> None:
        """
